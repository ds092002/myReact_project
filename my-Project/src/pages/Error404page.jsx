...
const Error404page = () => {
  return (
    ...
    <Link to='/'><button className="bg-[#0068C8] text-[#fff] border-1 border-[#0068C8] hover:bg-[#fff] hover:text-[#0068C8] transition duration-300 mt-3 font-bold px-7 py-2 lg:px-10 lg:py-2.5 rounded-lg uppercase">Back to homepage</button></Link>
</div>
  )
}
