...
const Error404page = () => {
  return (
    ...
    <a href="https://www.google.com"><button className="bg-[#0068C8] text-white mt-3 font-bold px-7 py-2 lg:px-10 lg:py-2.5 rounded-lg uppercase">Back to homepage</button></a>
</div>
  )
}
